...
export const metadata: Metadata = {
  ...
  description:
    'Bioestimulantes, fertilizantes orgánicos OMRI y bioprotección para agricultura de exportación. 47 productos · 35 cultivos con protocolo agronómico. Asesoría técnica directa. Zapotiltic, Jalisco.',
  ...
  twitter: {
    ...
    title: 'Biotiza — Biosoluciones agrícolas mexicanas',
    description: '47 productos · 35 cultivos con protocolo. Asesoría técnica directa en campo.',
