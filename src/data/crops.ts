...
const TOMATE: FullCropProtocol = {
  ...
  featured_products: ['bp-calcio', 'bp-koren', 'bp-cuaje', 'bp-gross', 'ca-ultra', 'zen-chrys'],
  ...
  stages: [
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'bp-magnesio', productName: 'BP Magnesio', line: 'organicos', dose: '2 mL/L', method: 'Foliar', frequency: 'Cada 10-15 días o al detectar clorosis intervenal', notes: 'Alternativa OMRI orgánica al mg-ultra: 16% MgO quelado, sin sulfatos · para productores con certificación orgánica de exportación · per catálogo recommended_dose foliar 1.5-2.5 mL/L', isProtection: false },
        ...
        { productId: 'bp-ferrum', productName: 'BP Ferrum', line: 'nutricion', dose: '0.75 mL/L', method: 'Foliar', frequency: 'Cada 14-21 días o al detectar clorosis férrica', notes: 'Hierro doblemente quelatado 9% estable hasta pH 9 (suelos calcáreos): clave en fotosíntesis, transferencia de electrones y reducción de nitratos · per catálogo recommended_dose foliar 0.5-1 mL/L' },
        { productId: 'bp-nitro-fx', productName: 'BP Nitro FX', line: 'organicos', dose: '1.75 mL/L', method: 'Foliar', frequency: 'Cada 10-14 días en etapa vegetativa', notes: 'L-aminoácidos vegetales 16% (doble hidrólisis enzimática) + N + P: anti-estrés post-trasplante/post-frío, potencia productos nutricionales del programa, mejora calibre y calidad · OMRI · per catálogo recommended_dose foliar 1.5-2 mL/L' },
        ...
        { productId: 'zen-can', productName: 'Zen-Can', line: 'bioproteccion', dose: '1.5 mL/L', method: 'Foliar', frequency: 'Cada 7-10 días; alternar con otros modos de acción', notes: 'Eugenol de canela 25%: repelente para mosca blanca, trips e insectos de cuerpo blando; doble función biofungicida (oídio/botrytis) · alternar modos de acción para evitar resistencias · per catálogo recommended_dose foliar 1-2 mL/L', isProtection: true },
      ],
    },
    {
...
const FRESA: FullCropProtocol = {
  ...
  featured_products: ['ae-calcium', 'bp-fiore', 'bp-cuaje', 'zen-fungi', 'zen-chrys', 'bp-koren'],
  ...
  stages: [
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'bp-magnesio', productName: 'BP Magnesio', line: 'organicos', dose: '2 mL/L', method: 'Foliar', frequency: 'Cada 10-15 días o al detectar clorosis intervenal', notes: '16% MgO orgánico quelado con ácidos carboxílicos, OMRI Listed · activa síntesis de clorofila y absorción de P · per catálogo recommended_dose foliar 1.5-2.5 mL/L', isProtection: false },
...
const ARANDANO: FullCropProtocol = {
  ...
  featured_products: ['bp-ferrum', 'bp-koren', 'zen-fungi', 'zen-chrys'],
  ...
  stages: [
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'vgn-brotanic', productName: 'BROTANIC', line: 'nutricion', dose: '1.5 → 2.0 → 2.5 L / 200 L agua (foliar) · 2–3 L/ha (riego)', method: 'Foliar / Fertirrigación', frequency: '3 aplicaciones escalonadas', notes: 'Genera nuevos haces vasculares → mayor flujo de savia y mejor asimilación de nutrientes y fitosanitarios; brotación sin hormonas' },
        { productId: 'bp-nitro-fx', productName: 'BP Nitro FX', line: 'organicos', dose: '1.75 mL/L', method: 'Foliar', frequency: 'Cada 10-14 días en etapa vegetativa', notes: 'L-aminoácidos vegetales 16% (doble hidrólisis enzimática) + N + P: anti-estrés en brotación de canes, potencia productos nutricionales del programa, mejora calibre y calidad · OMRI · per catálogo recommended_dose foliar 1.5-2 mL/L' },
        ...
        { productId: 'zen-can', productName: 'Zen-Can', line: 'bioproteccion', dose: '1.5 mL/L', method: 'Foliar', frequency: 'Cada 7-10 días; alternar con otros modos de acción', notes: 'Eugenol de canela 25%: repelente para trips californiano e insectos de cuerpo blando; doble función biofungicida (oídio/botrytis) · rotar con Zen-Chrys para evitar resistencias · per catálogo recommended_dose foliar 1-2 mL/L', isProtection: true },
  ...
  stages: [
    {
      ...
      products: [
        ...
        { productId: 'bp-ferrum', productName: 'BP Ferrum', line: 'nutricion', dose: '0.75 mL/L', method: 'Foliar', frequency: 'Cada 14-21 días o al detectar clorosis férrica', notes: 'Hierro doblemente quelatado 9% estable hasta pH 9: previene clorosis férrica intervenal en aguacate · activa fotosíntesis, transferencia de electrones y reducción de nitratos · per catálogo recommended_dose foliar 0.5-1 mL/L' },
  ...
  stages: [
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'bp-nitro-fx', productName: 'BP Nitro FX', line: 'organicos', dose: '1.75 mL/L', method: 'Foliar', frequency: 'Cada 10-14 días en etapa vegetativa', notes: 'L-aminoácidos vegetales 16% (doble hidrólisis enzimática) + N + P: anti-estrés post-trasplante y golpes de calor, potencia productos nutricionales del programa, mejora calibre · OMRI · per catálogo recommended_dose foliar 1.5-2 mL/L' },
        ...
        { productId: 'agb-entomotri', productName: 'ENTOMOTRI®', line: 'bioproteccion', dose: '420 g / 200 L de agua', method: 'Foliar', frequency: '2 aplicaciones a intervalos de 5 días', notes: 'Triple sinergia entomopatógena (Metarhizium + Beauveria + Paecilomyces) específica contra paratrioza (Bactericera cockerelli) — vector de punta morada · per catálogo recommended_dose foliar 360-480 g / 200 L de agua', isProtection: true },
        { productId: 'zen-can', productName: 'Zen-Can', line: 'bioproteccion', dose: '1.5 mL/L', method: 'Foliar', frequency: 'Cada 7-10 días; alternar con otros modos de acción', notes: 'Eugenol de canela 25%: repelente para trips (vector TSWV), mosca blanca e insectos de cuerpo blando; doble función biofungicida (oídio/botrytis) · alternar modos de acción para evitar resistencias · per catálogo recommended_dose foliar 1-2 mL/L', isProtection: true },
      ],
    },
    {
      id: 'floracion', name: 'Floración', emoji: '🌸',
...
const FRAMBUESA: FullCropProtocol = {
  ...
  featured_products: ['bp-koren', 'ae-calcium', 'zen-fungi', 'zen-chrys', 'bp-fiore', 'bp-cuaje'],
  ...
  stages: [
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'vgn-brotanic', productName: 'BROTANIC', line: 'nutricion', dose: '1.5 → 2.0 → 2.5 L / 200 L agua (foliar) · 2–3 L/ha (riego)', method: 'Foliar / Fertirrigación', frequency: '3 aplicaciones escalonadas', notes: 'Genera nuevos haces vasculares → mayor flujo de savia y mejor asimilación de nutrientes y fitosanitarios; brotación sin hormonas' },
        { productId: 'bp-nitro-fx', productName: 'BP Nitro FX', line: 'organicos', dose: '1.75 mL/L', method: 'Foliar', frequency: 'Cada 10-14 días en etapa vegetativa', notes: 'L-aminoácidos vegetales 16% (doble hidrólisis enzimática) + N + P: anti-estrés en brotación de canes floricane, potencia productos nutricionales del programa, mejora calibre y calidad · OMRI · per catálogo recommended_dose foliar 1.5-2 mL/L' },
        ...
        { productId: 'zen-can', productName: 'Zen-Can', line: 'bioproteccion', dose: '1.5 mL/L', method: 'Foliar', frequency: 'Cada 7-10 días; alternar con otros modos de acción', notes: 'Eugenol de canela 25%: repelente para trips, mosca blanca y araña roja; doble función biofungicida (oídio/botrytis) · alternar con Zen-Fungi para evitar resistencias · per catálogo recommended_dose foliar 1-2 mL/L', isProtection: true },
      ],
    },
    {
...
const ZARZAMORA: FullCropProtocol = {
  ...
  featured_products: ['ae-calcium', 'bp-fiore', 'zen-fungi', 'k-ultra', 'bp-koren', 'bp-gross'],
  ...
  stages: [
    {
      ...
      color: 'bg-emerald-100', textColor: 'text-emerald-700',
      products: [
        { productId: 'bp-koren', productName: 'BP Koren', line: 'organicos', dose: '2 mL/L', method: 'Drench', frequency: 'Al inicio de brotación', notes: 'Estimular la brotación homogénea de yemas' },
  ...
  stages: [
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'agb-paecilom', productName: 'PAECILOM®', line: 'bioproteccion', dose: '2 g/L', method: 'Aspersión', frequency: '2 aplicaciones a intervalos de 7 días', notes: 'Paecilomyces fumosoroseus controla mosquita blanca y psílido vector del HLB (Diaphorina citri): aplicar al pico de brotación tierna · per catálogo recommended_dose foliar 240-480 g/200L · COFEPRIS + OMRI', isProtection: true },
        { productId: 'agb-lecanii-green', productName: 'LECANII GREEN®', line: 'bioproteccion', dose: '2 mL/L', method: 'Aspersión', frequency: 'Al umbral del psílido vector', notes: 'Lecanicillium lecanii controla psílido vector del HLB (Diaphorina citri) y áfidos en brote tierno: monitoreo semanal de brotes nuevos', isProtection: true },
  ...
  stages: [
    {
      ...
      color: 'bg-emerald-100', textColor: 'text-emerald-700',
      products: [
        { productId: 'bp-koren', productName: 'BP Koren', line: 'organicos', dose: '2 mL/L', method: 'Drench', frequency: 'Días 1, 7, 14', notes: 'En cherry el arraigo debe ser homogéneo para evitar racimos desfasados' },
  ...
  stages: [
    {
      ...
      color: 'bg-emerald-100', textColor: 'text-emerald-700',
      products: [
        { productId: 'bp-koren', productName: 'BP Koren', line: 'organicos', dose: '2 mL/L', method: 'Drench', frequency: 'Días 1 y 10', notes: 'AIB + extracto de algas reducen estrés de trasplante' },
  ...
  stages: [
    {
      ...
      color: 'bg-emerald-100', textColor: 'text-emerald-700',
      products: [
        { productId: 'bp-koren', productName: 'BP Koren', line: 'organicos', dose: '2 mL/L', method: 'Drench', frequency: 'Días 1, 10, 21', notes: 'Arraigo rápido es clave — en apio la raíz define la capacidad de absorber Ca luego' },
...
const MAIZ: FullCropProtocol = {
  ...
  featured_products: ['n-ultra', 'p-ultra', 'k-ultra', 'bp-zinc', 'bp-mol'],
  ...
  stages: [
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'vgn-brotanic', productName: 'BROTANIC', line: 'nutricion', dose: '0.5 → 1.0 → 1.5 L / 200 L agua', method: 'Foliar', frequency: '3 aplicaciones escalonadas desde V3', notes: 'Genera nuevos haces vasculares → mayor flujo de savia y mejor asimilación de nutrientes y fitosanitarios; brotación sin hormonas' },
...
const CANA_AZUCAR: FullCropProtocol = {
  ...
  featured_products: ['k-ultra', 'n-ultra', 'bp-mix', 'bp-koren', 'bp-potasio'],
  ...
  stages: [
    {
      ...
      color: 'bg-emerald-100', textColor: 'text-emerald-700',
      products: [
        { productId: 'bp-koren', productName: 'BP Koren', line: 'organicos', dose: '3 L/ha', method: 'Drench', frequency: 'Al momento de la plantación', notes: 'AIB estimula brotación uniforme de yemas de la cepa' },
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'vgn-brotanic', productName: 'BROTANIC', line: 'nutricion', dose: '0.5 → 1.0 → 1.5 L / 200 L agua', method: 'Foliar', frequency: '3 aplicaciones escalonadas durante macollo', notes: 'Genera nuevos haces vasculares → mayor flujo de savia y mejor asimilación de nutrientes y fitosanitarios; brotación sin hormonas' },
      ],
    },
    {
    ...
    },
    {
      ...
      products: [
        ...
        { productId: 'bp-koren', productName: 'BP Koren', line: 'organicos', dose: '2 L/ha', method: 'Drench', frequency: 'Post-corte en el socado', notes: 'AIB estimula rebrote de yemas basales para una soca productiva' },
      ],
    },
  ],
}
  ...
  stages: [
    {
      ...
      products: [
        ...
        { productId: 'bp-koren', productName: 'BP Koren', line: 'organicos', dose: '2 L/ha', method: 'Drench', frequency: 'Al primer riego', notes: 'AIB estimula raíz principal antes de ramificación lateral — raíz fuerte = más nódulos' },
