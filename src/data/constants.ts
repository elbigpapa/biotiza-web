...
export const CROPS_DATA: CropConfig[] = [
  ...
  { id: 'calabaza',     name: 'Calabaza',        slug: 'calabaza',     emoji: '🎃', gradientFrom: 'from-orange-600',  gradientTo: 'to-amber-500',   description: 'Cucurbita moschata / C. maxima' },
  { id: 'calabacin',    name: 'Calabacín',       slug: 'calabacin',    emoji: '🥒', gradientFrom: 'from-green-600',   gradientTo: 'to-lime-500',    description: 'Cucurbita pepo (calabacita / zucchini)' },
